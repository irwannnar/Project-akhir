                ...
                <form action="{{ route('spending.store') }}" method="POST" id="spendingForm">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                        ...
                        <a href="{{ route('spending.index') }}"
                           class="bg-gray-300 hover:bg-gray-400 text-gray-700 font-medium py-2 px-6 rounded-lg transition duration-200 flex items-center justify-center gap-2 text-center focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 active:scale-95">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
