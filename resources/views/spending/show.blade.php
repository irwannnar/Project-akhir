                        ...
                        <div class="flex gap-2">
                            ...
                            <form action="{{ route('spending.destroy', $spending->id) }}" method="POST">
                                ...
                                <button type="submit" 
                                        ...
                                        class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200 flex items-center gap-2 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 active:scale-95">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
