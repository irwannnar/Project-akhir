<x-layout.default>
    <div class="container mx-auto p-6" x-data="dashboard()" x-init="init()">
        ...
        <!-- Perbaikan utama: Grid layout yang benar -->
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
            <!-- Grafik - mengambil 3 kolom -->
            <div class="lg:col-span-3 bg-white rounded-lg shadow p-6">
                <h2 class="text-gray-800 text-xl font-semibold mb-4">Grafik Profit Tahunan</h2>
                <div class="h-80"> <!-- Container dengan fixed height -->
                    <canvas id="profitChart"></canvas>
                </div>
            </div>

            <!-- Statistik Cards - mengambil 1 kolom -->
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-xl font-bold text-blue-600">
                                {{ number_format($totalProductsSold, 0, ',', '.') }} product
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <tbody>
                            @foreach ($recentTransactions as $transaction)
                                <tr class="border-b">
                                    ...
                                    <td class="px-4 py-2 text-sm">RP {{ number_format($transaction->total_price) }}</td>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <h2 class="text-gray-800 text-xl font-semibold mb-4">Produk Terlaris</h2>
                <div class="space-y-3">
                ...
                return {
                    ...
                    initChart() {
                        ...
                        new Chart(ctx, {
                            ...
                            options: {
                                responsive: true,
                                maintainAspectRatio: false, // Penting untuk container dengan fixed height
                                plugins: {
                                    legend: {
                                        display: false
                                    }
