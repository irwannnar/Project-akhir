                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @php
                                                ...
                                                $config = $statusConfig[$order->status] ?? ['class' => 'bg-gray-100 text-gray-800', 'label' => $order->status];
                                            @endphp
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                @if($order->status !== 'completed')
                                                    ...
                                                    <form action="{{ route('transaction.mark-completed', $order->id) }}" 
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($purchases as $purchase)
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">{{ $purchase->transaction_number }}</div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                @if($purchase->status !== 'completed')
                                                    ...
                                                    <form action="{{ route('transaction.mark-completed', $purchase->id) }}" 
                                                          method="POST" class="inline">
                                                        @csrf
                                                        @method('PATCH')
                                                        <button type="submit" 
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Apakah Anda yakin ingin menghapus transaksi dari <span id="customerName" class="font-semibold"></span>?
