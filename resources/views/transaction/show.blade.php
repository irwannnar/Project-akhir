                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-white">
                    <div class="flex justify-between items-start">
                        ...
                        <div class="flex flex-col items-end space-y-2">
                            ...
                            @endphp
                            <span class="px-3 py-1 rounded-full text-sm font-medium {{ $statusClasses[$transaction->status] }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @if($transaction->type == 'purchase')
                                <div>
                                    ...
                                    <p class="text-gray-800 mt-1">{{ $transaction->product->name ?? 'Produk tidak ditemukan' }}</p>
                                </div>
                            @else
                                <div>
                                    <label class="block text-sm font-medium text-gray-500">Layanan Cetak</label>
                                    <p class="text-gray-800 mt-1">{{ $transaction->printing->nama_layanan ?? 'Layanan tidak ditemukan' }}</p>
                                </div>
                                <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            @if($transaction->paid_at)
                                <div>
                                    ...
                                    <p class="text-gray-800 mt-1">{{ $transaction->paid_at->format('d M Y H:i') }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
