...
<div class="py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('orders.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
            + Tambah Pesanan
        </a>
    </div>
        ...
        <table class="min-w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <a href="{{ route('orders.show', $order) }}" class="text-blue-600 hover:underline mr-2">Detail</a>
                        <a href="{{ route('orders.edit', $order) }}" class="text-green-600 hover:underline mr-2">Edit</a>
